...
pub fn rules_registry() -> &'static HashMap<&'static str, Rule> {
    RULES_REGISTRY.get_or_init(|| {
        ...
        map.insert(
            "required",
            Box::new(|f: &str, n: &str, v: Option<&Value>, val: &Validator, _: Option<&str>| {
        ...
        map.insert(
            "nullable",
            Box::new(|_f: &str, _n: &str, _v: Option<&Value>, _val: &Validator, _: Option<&str>| {
                Ok(())
            }) as Rule,
        );
        ...
        map.insert(
            "min",
            Box::new(|f: &str, n: &str, v: Option<&Value>, val: &Validator, p: Option<&str>| {
